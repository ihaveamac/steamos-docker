...
define rootfs
	...
	mkdir -vp $(BUILDDIR)/usr/lib/holo/pacmandb/ $(OUTPUTDIR)
	...
	fakechroot -- fakeroot -- pacman -Sy -r $(BUILDDIR) \
		--noconfirm --dbpath $(BUILDDIR)/usr/lib/holo/pacmandb \
...
$(OUTPUTDIR)/base.tar.zst:
	$(call rootfs,base,base holo-base)
...
image-base: $(OUTPUTDIR)/Dockerfile.base
	${DOCKER} build -f $(OUTPUTDIR)/Dockerfile.base -t docker.io/ianburgwin/steamos:latest -t docker.io/ianburgwin/steamos:base -t docker.io/ianburgwin/steamos:3.6 -t docker.io/ianburgwin/steamos:3.6-base $(OUTPUTDIR)
...
image-base-devel: image-base $(OUTPUTDIR)/Dockerfile.base-devel
	${DOCKER} build -t docker.io/ianburgwin/steamos:base-devel -t docker.io/ianburgwin/steamos:3.6-base-devel - < $(OUTPUTDIR)/Dockerfile.base-devel

.PHONY: docker-image-buildpack
image-buildpack: image-base-devel $(OUTPUTDIR)/Dockerfile.buildpack
	${DOCKER} build -t docker.io/ianburgwin/steamos:buildpack -t docker.io/ianburgwin/steamos:3.6-buildpack - < $(OUTPUTDIR)/Dockerfile.buildpack

.PHONY: docker-image-buildpack-extra
image-buildpack-extra: image-buildpack $(OUTPUTDIR)/Dockerfile.buildpack-extra
	${DOCKER} build -t docker.io/ianburgwin/steamos:buildpack-extra -t docker.io/ianburgwin/steamos:3.6-buildpack-extra - < $(OUTPUTDIR)/Dockerfile.buildpack-extra
